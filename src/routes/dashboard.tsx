...
import { AnalyticsSection,DatabaseSection,DomainSection,IntegrationsSection,SecuritySection,SeoSection,UsersSection } from "@/components/dashboard/ManagementSections";
